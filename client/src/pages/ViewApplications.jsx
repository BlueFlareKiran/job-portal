                            ...
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b relative'>
                                    {applicant.status === "pending" ? (
                                        // Show the "..." button when status is Pending
                                        ...
                                        // If status is "Accepted" or "Rejected", display the status
                                        <div className={applicant.status === 'Accepted' ? 'text-green-500' : 'text-red-500'}>
                                            {applicant.status}
                                        </div>
                                    )}
                                </td>
